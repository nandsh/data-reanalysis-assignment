...
I have also replicated two of the simple linear regression models established by the authors. One of them looks into the effects of the explanatory variables on the log(APR) without considering the region/income of that country into consideration. The second one of them looks at the effect of the explanatory variables with regional dummies in the model equation.  
...
```
####Author's Models
<img src="https://raw.githubusercontent.com/nandsh/data-reanalysis-assignment/master/MultipleRegressionResults_1.png"/>
...
```
####Author's Models
<img src="https://raw.githubusercontent.com/nandsh/data-reanalysis-assignment/master/MultipleRegressionResults_2.png"/>